...
dcomplex hypgeo(dcomplex a, dcomplex b, dcomplex c, dcomplex z);
void hypser(dcomplex a, dcomplex b, dcomplex c, dcomplex z,
        dcomplex *series, dcomplex *deriv);
...
void laguer(dcomplex a[], int m, dcomplex *x, int *its);
...
void dodeint(double ystart[], int nvar, double x1, double x2,
        double eps, double h1, double hmin, int *nok, int *nbad,
        void (*derivs)(double, double [], double []),
        void (*rkqs)(double [], double [], int, double *, double, double,
        double [], double *, double *, void (*)(double, double [], double [])));
void myodeint(double ystart[], int nvar, double x1, double x2,
        double eps, double h1, double hmin, int *nok, int *nbad,
        void (*derivs)(double, double [], double []),
        void (*rkqs)(double [], double [], int, double *, double, double,
        double [], double *, double *, void (*)(double, double [], double [])));
...
void drkck(double y[], double dydx[], int n, double x, double h,
        double yout[], double yerr[], void (*derivs)(double, double [], double []));
...
void rkqs(double y[], double dydx[], int n, double *x,
        ...
        void (*derivs)(double, double [], double []));
void drkqs(double y[], double dydx[], int n, double *x,
        double htry, double eps, double yscal[], double *hdid, double *hnext,
        void (*derivs)(double, double [], double []));
void myrkqs(double y[], double dydx[], int n, double *x,
        double htry, double eps, double yscal[], double *hdid, double *hnext,
        void (*derivs)(double, double [], double []));
...
void svbksb(double **u, double w[], double **v, int m, int n, double b[],
        double x[]);
int  svdcmp(double **a, int m, int n, double w[], double **v); /* Returns TRUE/FALSE JNI 16-Nov-00 */
