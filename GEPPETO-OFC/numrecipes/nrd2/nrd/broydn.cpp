...
#define FREETHINGS free_dvector(fvec,1,n),free_dvector(xold,1,n),free_dvector(w,1,n),free_dvector(t,1,n),free_dvector(s,1,n),free_dmatrix(r,1,n,1,n),free_dmatrix(qt,1,n,1,n),free_dvector(p,1,n),free_dvector(g,1,n),free_dvector(fvcold,1,n),free_dvector(d,1,n),free_dvector(c,1,n);


// JNI 16/Jun/2000 Added "extern" (already defined in module: NEWT.c)
extern int nn;
extern double *fvec;
...
if (test<0.01*TOLF) { FREETHINGS return; }
...
if (test < TOLMIN) { FREETHINGS return; }
...
if (test < TOLX) { FREETHINGS return; }
