...
/****************************************************************************/
// This version modifies function names to compile inside libMatrix
/****************************************************************************/
...
/* allocate an unsigned long dvector with subscript range v[nl..nh] */
{
unsigned long *v;
...
/* allocate a double dvector with subscript range v[nl..nh] */
{
double *v;
...
/* allocate a float dmatrix with subscript range m[nrl..nrh][ncl..nch] */
{
...
/* allocate a int dmatrix with subscript range m[nrl..nrh][ncl..nch] */
{
long i, nrow=nrh-nrl+1,ncol=nch-ncl+1;
int **m;
...
/* point a subdmatrix [newrl..][newcl..] to a[oldrl..oldrh][oldcl..oldch] */
{
...
/* allocate a double dmatrix m[nrl..nrh][ncl..nch] that points to the dmatrix
...
/* free an int dvector allocated with ivector() */
{
free((FREE_ARG) (v+nl-NR_END));
}

void free_cvector(unsigned char *v, long nl, long nh)
/* free an unsigned char dvector allocated with cvector() */
{
free((FREE_ARG) (v+nl-NR_END));
}

void free_lvector(unsigned long *v, long nl, long nh)
/* free an unsigned long dvector allocated with lvector() */
{
free((FREE_ARG) (v+nl-NR_END));
}
...
/* free a double dmatrix allocated by dmatrix() */
{
free((FREE_ARG) (m[nrl]+ncl-NR_END));
free((FREE_ARG) (m+nrl-NR_END));
}
...
/* free an int dmatrix allocated by imatrix() */
{
free((FREE_ARG) (m[nrl]+ncl-NR_END));
free((FREE_ARG) (m+nrl-NR_END));
}
...
/* free a subdmatrix allocated by subdmatrix() */
{
